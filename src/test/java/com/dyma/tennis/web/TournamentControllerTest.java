...
public class TournamentControllerTest {
    ...
    public void shouldRetrieveTournament() throws Exception {
        // Given
        String tournamentToRetrieve = "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12";
    ...
    public void shouldReturn404NotFound_WhenTournamentDoesNotExist() throws Exception {
        // Given
        String tournamentToRetrieve = "rolandgarros";
        Mockito.when(tournamentService.getByIdentifier(tournamentToRetrieve)).thenThrow(new TournamentNotFoundException("rolandgarros"));

        // When / Then
        mockMvc.perform(get("/tournaments/rolandgarros"))
