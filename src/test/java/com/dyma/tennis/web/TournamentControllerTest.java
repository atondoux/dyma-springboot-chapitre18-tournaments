...
public class TournamentControllerTest {
    ...
    public void shouldListAllTournaments() {
        ...
        json.extractingPath("$[0].name").isEqualTo("Australian Open");
        json.extractingPath("$[1].name").isEqualTo("French Open");
        json.extractingPath("$[2].name").isEqualTo("Wimbledon");
        json.extractingPath("$[3].name").isEqualTo("US Open");
    }
    ...
    public void shouldRetrieveTournament() {
        ...
        // Then
        var json = response.assertThat().hasStatus(HttpStatus.OK).bodyJson();
        json.extractingPath("$.name").isEqualTo("French Open");
    }
