...
public class TournamentService {
    ...
    public Tournament getByIdentifier(String identifier) {
        log.info("Invoking getByIdentifier with identifier={}", identifier);
        try {
            Optional<TournamentEntity> tournament = tournamentRepository.findOneByIdentifier(UUID.fromString(identifier));
    ...
    public Tournament update(TournamentToUpdate tournamentToUpdate) {
        ...
        try {
            Optional<TournamentEntity> existingTournament = tournamentRepository.findOneByIdentifier(UUID.fromString(tournamentToUpdate.identifier()));
    ...
    public void delete(String identifier) {
        ...
        try {
            Optional<TournamentEntity> tournamentToDelete = tournamentRepository.findOneByIdentifier(UUID.fromString(identifier));
